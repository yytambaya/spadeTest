      ...
      <ScrollView>
        ...
        <NativeBaseProvider>
          <Box minH={deviceHeight} border="1" alignSelf={"center"} borderRadius="md" w={"92%"} mt={5}>
            ...
            <Box borderRadius={5} bgColor={"#273D4B"} px="4" pb="3">
            <Box display={"flex"} alignItems={"center"} pt={10} pb={8}>
              
              <Text fontSize="sm" pb={2} color={"#ECF2F5"}>You Owe</Text>  
              <Heading size="xl" color={"#FFFFFF"}>N 500.000</Heading>
            ...
            <Box mt="5">
              ...
              <Box>
                ...
                <Box mt="3">
                <Box borderRadius={6} w="150" pt="5" pb="4" px="15" py="2" bgColor={"#ECFAFC"}>
                  <Circle size="25px" bg={"#CAF0F8"}>
                    <Image size={3} source={require('../../../assets/icons/others/Vector.png')} alt="icon"/>
                  </Circle>
                  <Heading mb="3" mt="5" size="sm" color={"#00B4D8"}>Shop Loan</Heading>
                  <Text fontSize="xs" color={"#273D4B"}>
                    Shop available food
                    items  on loan, worth 
                    up to N 100,000
                  ...
                  <HStack alignItems={"center"} space={6} mt="7">
                    <Text fontSize={"xs"} color="#00B4D8">Flexible loan term</Text>
                    <Circle size="13px" bg="#CAF0F8">
                      <Foundation name="arrow-right" size={10} color="white"/>
                  </Circle>
                  </HStack>
                </Box>
